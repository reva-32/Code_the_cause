...
const styles = {
  container: { maxWidth: "1200px", margin: "0 auto", padding: "25px", fontFamily: "'Inter', sans-serif", backgroundColor: "#f8fafc", minHeight: "100vh" },
  ...
  welcomeModal: { background: "#fff", padding: "30px", borderRadius: "20px", maxWidth: "350px", textAlign: "center", boxShadow: "0 20px 40px rgba(0,0,0,0.2)" },
  welcomeIcon: { fontSize: "36px", marginBottom: "12px" },
  welcomeBtn: { width: "100%", padding: "12px", background: "#065f46", color: "#fff", border: "none", borderRadius: "10px", fontWeight: "700", cursor: "pointer", transition: "all 0.2s ease", fontSize: "13px" },
  sideHeader: { display: "flex", justifyContent: "space-between", marginBottom: "35px", paddingBottom: "20px", borderBottom: "1px solid #e2e8f0" },
  badge: { display: "inline-block", backgroundColor: "#ecfdf5", color: "#059669", padding: "4px 10px", borderRadius: "6px", fontSize: "9px", fontWeight: "900", marginBottom: "8px", border: "1px solid #10b981" },
  mainTitle: { fontSize: "28px", fontWeight: "900", color: "#064e3b", margin: 0, letterSpacing: "-1px" },
  subtitle: { color: "#64748b", margin: "4px 0 0 0", fontSize: "14px" },
  guideBtn: { padding: "8px 16px", background: "#fff", color: "#1e293b", border: "1px solid #cbd5e1", borderRadius: "10px", cursor: "pointer", fontSize: "12px", fontWeight: "700", transition: "all 0.2s ease" },
  logoutBtn: { padding: "8px 20px", background: "#ef4444", color: "#fff", border: "none", borderRadius: "10px", cursor: "pointer", fontSize: "12px", fontWeight: "700", transition: "all 0.2s ease" },
  grid: { display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: "40px" },
  column: { display: "flex", flexDirection: "column", gap: "20px" },
  sectionSpacing: { marginBottom: "15px" },
  sectionTitle: { fontSize: "15px", fontWeight: "800", color: "#1e293b", marginBottom: "12px" },
  ...
  searchInput: { padding: "10px 10px 10px 32px", borderRadius: "10px", border: "1px solid #cbd5e1", fontSize: "12px", width: "180px", outline: "none" },
  addBtn: { background: "#065f46", color: "#fff", border: "none", padding: "14px", borderRadius: "14px", fontWeight: "800", cursor: "pointer", fontSize: "13px", transition: "all 0.2s ease" },
  studentCardContainer: { borderRadius: "16px", background: "#fff", marginBottom: "12px", border: "1px solid #f1f5f9", overflow: "hidden" },
  studentCard: { padding: "16px 20px", display: "flex", alignItems: "center" },
  studentName: { margin: 0, fontSize: "15px", fontWeight: "800", color: "#1e293b" },
  ageBadge: { fontSize: "11px", color: "#64748b", background: "#f1f5f9", padding: "2px 8px", borderRadius: "6px" },
  studentBadge: { fontSize: "9px", background: "#f0fdf4", padding: "3px 10px", borderRadius: "6px", fontWeight: "800", color: "#065f46", textTransform: "uppercase", border: "1px solid #bcf0da" },
  alertTagCritical: { fontSize: "9px", background: "#fef2f2", color: "#dc2626", padding: "2px 8px", borderRadius: "6px", fontWeight: "900", border: "1px solid #fee2e2" },
  alertTagVaccine: { fontSize: "9px", background: "#fffbeb", color: "#b45309", padding: "2px 8px", borderRadius: "6px", fontWeight: "900", border: "1px solid #fef3c7" },
  viewBtn: { border: "none", padding: "8px 14px", borderRadius: "8px", cursor: "pointer", fontSize: "11px", fontWeight: "700", transition: "all 0.2s ease" },
  missingAlert: { background: "#fffbeb", padding: "12px 20px", borderTop: "1px solid #fef3c7", display: "flex", alignItems: "center" },
  overdueAlert: { background: "#fef2f2", padding: "12px 20px", borderTop: "1px solid #fee2e2", display: "flex", alignItems: "center" },
  vitalsInput: { width: "60px", padding: "8px", borderRadius: "8px", border: "1px solid #cbd5e1", fontSize: "11px" },
  saveVitalsBtn: { background: "#065f46", color: "#fff", border: "none", padding: "8px 16px", borderRadius: "8px", cursor: "pointer", fontWeight: "700", fontSize: "11px" },
  toolGrid: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px" },
  exportBtnDeep: { background: "#065f46", color: "#fff", border: "none", padding: "14px", borderRadius: "14px", cursor: "pointer", display: "flex", alignItems: "center", gap: "10px" },
  exportBtnLight: { background: "#1e293b", color: "#fff", border: "none", padding: "14px", borderRadius: "14px", cursor: "pointer", display: "flex", alignItems: "center", gap: "10px" },
  exportText: { textAlign: "left", display: "flex", flexDirection: "column" },
  // Helper for nested export text
  exportTitle: { fontSize: "13px", fontWeight: "700" },
  exportSub: { fontSize: "10px", opacity: 0.8 },
  formCard: { background: "#fff", padding: "25px", borderRadius: "18px", border: "1px solid #f1f5f9" },
  examBtn: { background: "#065f46", color: "#fff", border: "none", padding: "14px", borderRadius: "12px", fontWeight: "900", cursor: "pointer", fontSize: "13px", width: "100%" },
  inputRow: { display: "flex", gap: "10px", marginBottom: "10px" },
  visitorInput: { flex: 1, padding: "12px", borderRadius: "10px", border: "1px solid #e2e8f0", fontSize: "12px", outline: "none" },
  visitorSelect: { flex: 1, padding: "12px", borderRadius: "10px", border: "1px solid #e2e8f0", fontSize: "12px" },
  logVisitorBtn: { background: "#065f46", color: "#fff", border: "none", padding: "14px", borderRadius: "12px", fontWeight: "800", width: "100%", fontSize: "13px" },
  visitorSearchInput: { padding: "6px 12px", borderRadius: "8px", border: "1px solid #e2e8f0", fontSize: "11px" },
  visitorCard: { background: "#fff", padding: "12px 18px", borderRadius: "14px", display: "flex", alignItems: "center", marginBottom: "10px", border: "1px solid #f1f5f9" },
  vName: { margin: 0, fontWeight: "800", fontSize: "14px", color: "#1e293b" },
  vPurposeBadge: { fontSize: "9px", backgroundColor: "#ecfdf5", color: "#059669", padding: "3px 8px", borderRadius: "6px", fontWeight: "800" },
  vMeta: { margin: "3px 0 0 0", fontSize: "11px", color: "#94a3b8" },
  vExitText: { margin: "3px 0 0 0", fontSize: "11px", color: "#ef4444", fontWeight: "800" },
  exitBtn: { background: "#fff", border: "1px solid #ef4444", color: "#ef4444", padding: "6px 12px", borderRadius: "8px", cursor: "pointer", fontSize: "10px", fontWeight: "800" }
};